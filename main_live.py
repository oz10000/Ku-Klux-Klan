...
Descripción: Bot con filtro microcapital, prioridad de oportunidades y reinversión total.
"""
...
class TradingBot:
    ...
    # --------------------------------------------------------------
    # Verificación de protecciones (TP/SL) – CORREGIDO
    # --------------------------------------------------------------
    ...
    # --------------------------------------------------------------
    # Filtro de activos para cuentas pequeñas
    # --------------------------------------------------------------
    def _apply_micro_filter(self, signals):
        """Excluye señales cuyo notional mínimo supere el margen disponible."""
        filtered = []
    ...
    # --------------------------------------------------------------
    # Manejo de eventos de posición (stops, cierres)
    # --------------------------------------------------------------
    ...
    # --------------------------------------------------------------
    # Colocación de orden con buffer adaptativo
    # --------------------------------------------------------------
    ...
    # --------------------------------------------------------------
    def run(self):
        logger.info("🚀 KRISHNA OMEGA ULTRA V9.1 INICIADO")
        ...
        while self.running:
            ...
            if kill_active:
                ...
                # 🔒 Verificación de protecciones cada ciclo
