...
if MODE_SELECTION == "DEBUG":
    ...
    TIME_SCORE_THRESHOLD = 5
    TIME_SCORE_MIN_FOR_ENTRY = 0.10
    ...
    VELOCITY_EXIT_MIN_ADX = 15
    VELOCITY_EXIT_MIN_KER = 0.30
    ...
    LEVERAGE = 5                       # Aumentado para mayor tamaño
    INITIAL_MARGIN_FACTOR = 1.0        # Usar todo el capital disponible
    FACTOR_STEP = 0.01
